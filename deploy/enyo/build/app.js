...
var i = n[r].split("=");
if (i.length == 2 && decodeURIComponent(i[0]) === t) return decodeURIComponent(i[1]);
}
}
return undefined;
}
enyo.cloudassistant || (enyo.cloudassistant = {});
var e = window.location || {}, t = e.protocol, n = t === "http:" ? 80 : t === "https:" ? 443 : undefined;
n = e.port ? e.port : n;
var r = e.hostname.split(".")[0], i = r.split("_"), s, o;
i.length > 1 ? (s = i.shift(), o = i.join("_")) : (s = "root", o = r);
var a = u(e.search, "token");
if (typeof a == "string") try {
a = JSON.parse(a);
} catch (f) {
enyo.error("cannot parse (JSON) token " + a), a = undefined;
} else a = undefined;
var l = function(e) {
return e === "false" ? !1 : e === "true" ? !0 : undefined;
}, c = e.search ? e.href.split(e.search)[0] : e.href, h = e.origin ? e.origin : e.protocol + "//" + e.host;
enyo.cloudassistant.props = {
appHostname: e.hostname,
appHost: e.host,
appProtocol: t,
port: n,
baseUrl: c,
origin: h,
caOwner: u(e.search, "caOwner"),
password: u(e.search, "password"),
token: a,
sessionId: u(e.search, "sessionId"),
caLocalName: u(e.search, "caLocalName"),
appPublisher: s,
appLocalName: o,
goTo: u(e.search, "goTo"),
unrestrictedToken: l(u(e.search, "unrestrictedToken"))
};
})();
...
var e = Math.floor(Math.random() * 1e16), t = "" + (new Date).getTime() + e;
return t;
...
return e && e.jsonrpc === "2.0" && e.method && e.params && e.params.length > 0 && !e.id;
}, o = function(e, t, n, s, o, u) {
var a = i(e, t, n, s, o, u);
return a.id = r(), a;
}, u = function(e) {
return e && e.jsonrpc === "2.0" && e.method && e.params && e.params.length > 0 && e.id;
}, a = function(e) {
return e && e.jsonrpc === "2.0" && e.error && e.error.code && e.error.data && e.error.data.length === 2 && e.id;
}, f = function(e) {
var t = S(e);
return t === n.noSuchCA || t === n.shutdownCA || t === n.checkpointFailure || t === n.prepareFailure || t === n.commitFailure || t === n.internalError;
}, l = function(e) {
return a(e) && S(e) === n.forceRedirect;
}, c = function(e) {
return a(e) && S(e) === n.notAuthorized;
}, h = function(e) {
return e && e.jsonrpc === "2.0" && e.result && e.result.length === 3 && e.id;
}, p = function(e) {
return u(e) || s(e) ? e.params[0] : h(e) ? e.result[0] : a(e) ? e.error.data[0] : undefined;
}, d = function(e, t) {
u(e) || s(e) ? e.params[0] = t : h(e) ? e.result[0] = t : a(e) ? e.error.data[0] = t : enyo.error("Setting meta in a badly defined msg " + e.toString());
}, v = function(e) {
var t = p(e);
return t ? t.sessionId : undefined;
}, m = function(e) {
var t = p(e);
return t ? t.token : undefined;
}, g = function(e) {
var t = p(e);
return t ? t.to : undefined;
}, y = function(e) {
var t = p(e);
return t ? t.from : undefined;
}, b = function(e) {
return h(e) ? e.result[1] : undefined;
}, w = function(e) {
return h(e) ? e.result[2] : undefined;
}, E = function(e) {
return a(e) ? e.error.data[1] : undefined;
}, S = function(e) {
return a(e) ? e.error.code : undefined;
}, x = function(e) {
return a(e) ? e.error.message : undefined;
}, T = function(e, t) {
if (!s(t)) throw new Error("msg:" + t + " not a notification");
if (typeof e[t.method] != "function") throw new Error("no method" + t.method + " in target");
var n = t.params.slice(0);
n.shift(), e[t.method].apply(e, n);
}, N = function(e, t) {
var n = p(e) || {};
n.token = t, d(e, n);
};
...
getAppReplyError: b,
getAppReplyData: w,
getSystemErrorData: E,
getSystemErrorCode: S,
getSystemErrorMsg: x,
setMeta: d,
setToken: N,
call: T
...
create: function() {
this.url = this.owner && this.owner.getPostUrl(), this.inherited(arguments);
},
invokeAsync: function(e, t, n) {
if (this.destroyed) throw new Error("Invoke on destroyed channel");
this._invokeAsync(e, 0, t, n);
},
updateToken: function(e) {
var t = enyo.cloudassistant.jsonRpc, n = this.owner, r = n.getToken();
t.setToken(e, r);
},
_invokeAsync: function(e, t, n, r) {
this.updateToken(e);
var i = enyo.json.stringify(e), s = new enyo.Ajax({
url: this.url,
method: this.method,
...
n.isSystemError(t) ? this.checkId(e, t) && this.systemErrorHandler(e, t) : n.isAppReply(t) ? this.checkId(e, t) && this.appReplyHandler(e, t) : this.badMessageHandler(e, t);
},
badMessageHandler: function(e, t) {
this.ignore(e, t, "Ignoring bad response");
},
appReplyHandler: function(e, t) {
var n = enyo.cloudassistant.jsonRpc, r = n.getAppReplyError(t), i = n.getAppReplyData(t);
r ? e.cbError(r) : e.cbOK(i);
},
checkId: function(e, t) {
return t.id !== e.msg.id ? (this.ignore(e, t, "Wrong Id"), !1) : !0;
},
transportErrorHandler: function(e, t) {
this.die(e, t, "Transport error");
},
systemErrorHandler: function(e, t) {
var n = enyo.cloudassistant.jsonRpc;
e.retries > this.maxRetries ? this.die(e, t, "Too many retries") : n.isRedirect(t) ? this.tryAgain(e) : n.isNotAuthorized(t) ? this.newLogin(e, t) : n.isRecoverable(t) ? (enyo.log("Channel: Retrying recoverable error " + enyo.json.stringify(t)), this.tryAgain(e)) : this.die(e, t, "Unrecoverable system error");
},
newLogin: function(e, t) {
var n = enyo.cloudassistant.jsonRpc, r = this.owner;
r.login(n.getToken(e.msg)), this.tryAgain(e);
},
tryAgain: function(e) {
var t = enyo.bind(this, "_invokeAsync", e.msg, e.retries + 1, e.cbOK, e.cbError);
setTimeout(t, this.retryTimeout);
},
ignore: function(e, t, n) {
enyo.error("Channel: Ignoring " + n + " Request:" + enyo.json.stringify(e.msg) + " Response:" + enyo.json.stringify(t));
},
die: function(e, t, n) {
var r = "Channel: " + n + " shutting down: Request:" + enyo.json.stringify(e.msg) + " Response:" + enyo.json.stringify(t);
enyo.error(r), this.doDisconnect({
msg: r
}), this.destroy();
}
});
...
create: function() {
this.inherited(arguments), this.url = this.url + "/backchannel", this.nextPull();
},
nextPull: function() {
setTimeout(enyo.bind(this, "pull"), 0);
},
pull: function() {
var e = enyo.cloudassistant.jsonRpc, t = this.owner;
if (!t) this.die({}, {}, "Parent session gone"); else {
var n = enyo.bind(this, "newMessageHandler"), r = enyo.bind(this, "errorMessageHandler"), i = e.request(t.getToken(), t.getCaName(), t.getMyId(), t.getSessionId(), t.getCallbackMethod());
this.invokeAsync(i, n, r);
}
},
newMessageHandler: function(e) {
this.nextPull(), this.doNotified({
msg: e
});
},
errorMessageHandler: function(e) {
this.nextPull(), e !== "timeout" && enyo.error("BackChannel: got non-timeout app error " + e);
},
badMessageHandler: function(e, t) {
e.retries > this.maxRetries ? this.die(e, inError, "Too many retries") : (this.ignore(e, t, "Retrying after ignoring bad response"), this.tryAgain(e));
}
});
...
enyo.kind({
name: "ca.RequestChannel",
kind: "ca.Channel",
invokeAsync: function(e, t, n) {
var r = enyo.cloudassistant.jsonRpc, i = r.request(e.token, e.to, e.from, e.sessionId, e.methodName, e.argsList);
arguments[0] = i, this.inherited(arguments);
}
});
...
enyo.kind({
name: "ca.LoginChannel",
kind: "ca.RequestChannel",
create: function() {
this.inherited(arguments), this.url = this.owner && this.owner.getLoginUrl();
},
newLogin: function(e, t) {
var n = enyo.cloudassistant.jsonRpc, r = n.getSystemErrorData(t), i = n.getSystemErrorMsg(t);
e.cbError({
data: r,
msg: i
});
...
create: function() {
this.postUrl = this.getAppProtocol() + "//" + this.getAppHost() + "/ca/" + this.getCaName(), this.loginUrl = this.getAppProtocol() + "//" + this.getAppHost() + "/login/" + this.getCaName(), this.caOwner = this.caOwner ? this.caOwner : this.caName.split("_")[0], this.myId = this.myId ? this.myId : this.caOwner + "_" + enyo.cloudassistant.jsonRpc.FROM_ID, this.callbackObject = this.callbackObject || this.defaultCallbackObject(), this.inherited(arguments), this.doOnline({
msg: this.postUrl
}), this.recoverChannels();
},
login: function(e) {
var t = this, n = function(e) {
t.token = e, t.doGoodCredentials({
token: e
}), t.doOnline({
msg: this.loginUrl
}), t.log("Authentication OK");
}, r = function(e) {
t.doBadCredentials({
msg: e.msg,
data: e.data
...
try {
this.$.loginChannel.invokeAsync(i, i.cbOK, i.cbError);
} catch (s) {
this.doOffline({
msg: this.loginUrl
}), this.warn(s), this.log(s.stack);
}
}
},
msgNotified: function(e, t) {
if (this.getCallbackObject()) try {
enyo.cloudassistant.jsonRpc.call(this.getCallbackObject(), t.msg);
} catch (n) {
this.warn(n), this.log(n.stack);
} else this.log(e.name, "got msg: " + t.msg);
return !0;
},
remoteInvoke: function(e, t, n, r) {
var i = {
token: this.getToken(),
to: this.getCaName(),
from: this.getMyId(),
...
this.reqQueue.push(i), this.flushReqQueue();
},
isOffline: function() {
return !this.$.requestChannel || !this.$.backChannel && !this.disableBackChannel || !this.$.loginChannel;
},
flushReqQueue: function() {
var e = this.reqQueue.shift();
if (!e) return !0;
if (!this.$.requestChannel) return this.reqQueue.unshift(e), !1;
try {
return this.$.requestChannel.invokeAsync(e, e.cbOK, e.cbError), this.flushReqQueue();
} catch (t) {
return this.doOffline({
msg: this.postUrl
}), this.reqQueue.unshift(e), this.warn(t), this.log(t.stack), !1;
}
},
channelDisconnected: function(e, t) {
this.doOffline({
msg: this.postUrl
}), this.removeComponent(e);
if (this.retries < this.maxRetries) {
this.retries = this.retries + 1;
var n = enyo.bind(this, "recoverChannels");
enyo.log("Retrying connection " + this.retries), setTimeout(n, this.retryTimeout);
} else this.die(e, t, "Too many attempts");
return !0;
},
recoverChannels: function() {
this.$.requestChannel || (this.createComponent({
name: "requestChannel",
kind: "ca.RequestChannel"
}), this.flushReqQueue() && this.doOnline({
msg: this.postUrl
})), !this.$.backChannel && !this.disableBackChannel && (this.createComponent({
name: "backChannel",
kind: "ca.BackChannel"
}), this.doOnline({
msg: this.postUrl
})), this.$.loginChannel || (this.createComponent({
name: "loginChannel",
kind: "ca.LoginChannel"
}), this.doOnline({
msg: this.loginUrl
...
die: function(e, t, n) {
var r = "Session: " + n + " shuting down: Request:" + enyo.json.stringify(e.msg) + " Response:" + enyo.json.stringify(t);
enyo.error(r), this.destroy();
},
...
components: [ {
kind: "ca.Login.CredentialsPopup",
name: "credentialsPopup",
onCredentials: "activate"
}, {
kind: "ca.Login.PasswordPopup",
name: "passwordPopup",
onPassword: "setNewPassword"
} ],
create: function() {
this.inherited(arguments);
var e = enyo.cloudassistant.props || {};
e.caLocalName && this.setCaLocalName(e.caLocalName), e.caOwner && this.setCaOwner(e.caOwner), e.token && this.setToken(e.token), e.password && this.setPassword(e.password), e.appPublisher && this.setAppPublisher(e.appPublisher), e.appLocalName && this.setAppLocalName(e.appLocalName), this.caOwner && this.caLocalName ? enyo.asyncMethod(this, this.activate, null, {}) : enyo.asyncMethod(this, this.askForCredentials, this.caOwner, this.caLocalName);
},
activate: function(e, t) {
this.setCaOwner(t.caOwner || this.caOwner), this.setCaLocalName(t.caLocalName || this.caLocalName);
var n = {
caOwner: this.caOwner,
caLocalName: this.caLocalName,
password: this.password,
token: this.token
};
return this.doLogin(n), !0;
},
askForCredentials: function(e, t) {
this.$.credentialsPopup.showPopup(e, t);
},
...
enyo.cloudassistant.props.token = e, this.token = e;
}
}), enyo.kind({
...
newPassword: function(e, t) {
var n = {};
n.password = this.$.passwordInput.getValue(), this.hidePopup(), this.doPassword(n), this.$.passwordInput.setValue("");
},
showPopup: function() {
this.show();
},
...
newCredentials: function(e, t) {
var n = {};
return n.caOwner = this.$.caOwnerInput.getValue(), n.caLocalName = this.$.caLocalNameInput.getValue(), n.caOwner && n.caLocalName && (this.hidePopup(), this.doCredentials(n)), !0;
},
showPopup: function(e, t) {
e && this.$.caOwnerInput.setValue(e), t && this.$.caLocalNameInput.setValue(t), this.show();
},
hidePopup: function() {
this.hide();
}
...
activate: function(e, t) {
var n = t.caOwner + "_" + t.caLocalName;
this.createComponent({
kind: "ca.Session",
name: "mySession",
onOnline: "connected",
...
return this.$.login && this.$.login.destroy(), this.$.mySession && this.$.mySession.destroy(), this.$.welcome.setContent("Logged off"), this.doLogout({}), !0;
},
connected: function(e, t) {
this.connStatus = !0, this.$.dot.setStyle("color: green;");
var n = this.$.login.getAppPublisher() === "root" ? "" : this.$.login.getAppPublisher() + "_";
return this.$.welcome.setContent(n + this.$.login.getAppLocalName() + "#" + this.$.login.getCaOwner() + "_" + this.$.login.getCaLocalName()), this.$.welcomeToolbar.render(), this.doSession({
...
return this.connStatus = !1, this.$.dot.setStyle("color: red;"), !0;
},
askForPassword: function(e, t) {
return t.data && t.data.accountsURL ? window.location.replace(t.data.accountsURL) : this.$.login.askForPassword(), !0;
},
setPassword: function(e, t) {
return this.$.mySession.setPassword(t.password), !0;
},
resetToken: function(e, t) {
return this.$.login.resetToken(t.token), !0;
}
});
